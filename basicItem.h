...
{
public:
	constexpr static item_type type = std::is_floating_point < T > ::value ? item_type::floatingPoint :
										std::is_signed < T > ::value ? item_type::signedNumber :
